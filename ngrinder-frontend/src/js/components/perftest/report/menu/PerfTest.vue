...
<script>
    ...
    export default class PerfTest extends Mixins(Base, ChartMixin, MessagesMixin) {
        ...
        mounted() {
            ...
            }).catch(err => this.showErrorMsg(this.i18n('common.message.loading.error'), err));
        ...
        processData(data, dataType, numOfTestRecord) {
            if (dataType === 'User_defined') {
                this.processUserDefinedData(data, numOfTestRecord);
                return;
            }
